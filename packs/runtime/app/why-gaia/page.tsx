export default function WhyGAIA(){
  return (<main className="mx-auto max-w-4xl px-6 py-16">
    ...
    <section className="mt-8"><h2 className="text-xl font-medium">Principles</h2><ul className="mt-2 list-disc pl-5 text-sm"><li>Clarity over jargon.</li><li>Proof over promises.</li><li>Safety over shortcuts.</li><li>Small wins over large plans.</li></ul></section>
    <section className="mt-12"><h2 className="text-xl font-medium">Two patterns compared</h2><figure className="mt-3 rounded-md border p-4">
      <svg role="img" aria-labelledby="title desc" width="100%" height="200" viewBox="0 0 820 200">
        <title id="title">Two patterns compared</title>
        <desc id="desc">Left shows one turn chat. Right shows an agentic plan that retrieves, calls tools, checks rules, and logs.</desc>
      ...
      <figcaption className="mt-2 text-sm text-muted-foreground">The agentic path plans, retrieves with citations, calls tools, checks rules, and logs the run.</figcaption>
    </figure></section>
    <div className="mt-10"><a href="/contact" className="btn btn-primary">Start a two week pilot</a></div>
  </main>);
}